...
<p>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-325%20passing-1c1c1e?style=flat-square" />
...
325 tests, all passing, all confined to loopback.
...
├── session/          The download loop and its parts: peer pool, workers, announcer, plan
