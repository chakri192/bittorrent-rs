...
<p>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-1122%20passing-1c1c1e?style=flat-square" />
...
1122 tests (1120 unit, 1 integration, 1 doctest), all passing. They stay on loopback, with one exception: a test of local discovery uses the real multicast group if the machine has one, and says so if it has not.
